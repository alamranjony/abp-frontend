...
import { SalesRepProductivitySummaryReportService } from 'src/app/services/reports/sales-rep-productivity-summary-report.service';

@Component({
  selector: 'app-sales-rep-productivity-summary-report',
  templateUrl: './sales-rep-productivity-summary-report.component.html',
  styleUrl: './sales-rep-productivity-summary-report.component.scss',
})
export class SalesRepProductivitySummaryReportComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private salesRepService: SalesRepProductivitySummaryReportService,
